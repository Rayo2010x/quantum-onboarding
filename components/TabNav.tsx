...
export type TabId = 'trilemma' | 'wallets' | 'quantumshield' | 'faq' | 'walletlab' | 'txsimulator';
interface Tab {
    id: TabId;
    label: string;
    icon: string;
...
const TABS: Tab[] = [
    ...
    { id: 'walletlab',     label: 'L1 Wallet Lab',  icon: '🔬' },
    { id: 'txsimulator',   label: 'Transaction Lab', icon: '⚡' },
];
